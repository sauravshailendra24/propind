        ...
        async with conn.cursor() as cur:
            ...
            await cur.execute(
                """SELECT onboarding_step, onboarding_completed,
                          ...
                          challenge_active_until, challenge_paid_at,
                          challenge_payment_id, challenge_order_id, challenge_status
            ...
            return {
                ...
                "challenge_active_until": str(srow[14]) if srow[14] else None,
                "challenge_paid_at": str(srow[15]) if srow[15] else None,
                "challenge_payment_id": srow[16],
                "challenge_order_id": srow[17],
                "challenge_status": srow[18] or "inactive",
            }